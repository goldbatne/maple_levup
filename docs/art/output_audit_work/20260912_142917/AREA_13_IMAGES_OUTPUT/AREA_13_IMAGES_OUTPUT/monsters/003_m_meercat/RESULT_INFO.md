...
- source_sheet: `SOURCE_SHEETS/003_m_meercat_s_mon_meercat_CAST_SOURCE_SHEET.png`
...
- `ICON/003_m_meercat_s_mon_meercat_ICON.png` / 1 frame / 256x256 RGBA / static
- `CAST/003_m_meercat_s_mon_meercat_CAST_FF00....png` / 8 frames / 384x384 RGBA / 0.10s per frame / non-loop one-shot
