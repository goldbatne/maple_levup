...
- source_sheet: `SOURCE_SHEETS/004_m_sand_dwarf_s_mon_sand_dwarf_REFERENCE_SOURCE_SHEET.png`
...
- `ICON/004_m_sand_dwarf_s_mon_sand_dwarf_ICON.png` / 1 frame / 256x256 RGBA / static
- `REFERENCE/004_m_sand_dwarf_s_mon_sand_dwarf_REFERENCE_FF00....png` / 6 frames / 256x256 RGBA / 0.10s per frame / preview-only non-loop
