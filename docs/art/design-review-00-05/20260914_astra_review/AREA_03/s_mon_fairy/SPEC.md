...
- 효과 발생 위치: 시전자 몸통 중심과 발밑 사이의 고정 피봇에서 ‘요정의 마법가루’의 별가루 같은 요정 분말이 나선으로 모였다 퍼지는 빛무리이 먼저 나타남
- 진행 방향: 별가루 같은 요정 분말이 나선으로 모였다 퍼지는 빛무리의 고유 결을 따라 한 번 확장·수축하며 불필요한 화면 횡단은 하지 않음
- 대상 표현: 확정 효과 ‘INT 계수 1.4로 반경 3 범위 최대 3대상 피해; 5초 재사용; 5장 보유 시 계수 ×1.8’가 지정한 대상만 표현하고 몬스터·플레이어 본체 실루엣은 넣지 않음
