...
- 몬스터 이름: 엑스텀프
- monster image RUID: `9d4f9e8f572548f692438ffa817eb52d`
- skill_id: `s_mon_axe_stump`
- 최종 스킬 이름: **도끼 휘두르기**
- 스킬 타입: **액티브**
- 보스 여부: 일반 몬스터
- 실제 현재 효과: ATK 계수 1.3로 반경 3 범위 대상 제한 없음 피해; 4초 재사용; 5장 보유 시 계수 ×1.8
- 실제 현재 동작: layer_ruids 2개; 타입 animationclip/animationclip; 스타일 clip/clip; 지연 0/0.14초; 지속 0.55/0.48초

## 원작/지역 연결

[P][A] 엑스텀프 명칭은 도끼와 연결되나 ‘휘두르기’는 몬스터가 도끼를 직접 드는 것으로 읽힐 수 있다.

## 시각 번역

- 핵심 소재: 도끼날 실루엣의 짧고 무거운 전방 궤적과 나무 부스러기. ‘엑스텀프 / 도끼 휘두르기’ 전용 소재이며 몬스터 본체는 VFX에 직접 넣지 않음
- 주 색상: 철회색 #8B9094; 핵심 실루엣의 중간톤과 어두운 외곽에 사용
- 보조 색상: 나무 갈색 #8B5A37; 타격 코어·잔상·소수 입자에만 사용해 같은 Area의 다른 몬스터와 구분
- 효과 발생 위치: 시전자 전방 15% 지점에서 ‘도끼 휘두르기’의 도끼날 실루엣의 짧고 무거운 전방 궤적과 나무 부스러기이 시작되어 발밑 높이와 공격축을 맞춤
- 진행 방향: 도끼날 실루엣의 짧고 무거운 전방 궤적과 나무 부스러기이 오른쪽으로 압축·가속하고 충돌점에서 짧게 넓어진 뒤 반대 방향 파편 없이 소멸
- 대상 표현: 확정 효과 ‘ATK 계수 1.3로 반경 3 범위 대상 제한 없음 피해; 4초 재사용; 5장 보유 시 계수 ×1.8’의 전방 피격 대상과 최초 충돌점을 표시하고 타격광은 대상 중심을 가리지 않는 외곽 고리로 제한
