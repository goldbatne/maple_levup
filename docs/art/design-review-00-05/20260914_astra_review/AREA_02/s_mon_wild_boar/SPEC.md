...
- 스킬 타입: **액티브**
- 보스 여부: 일반 몬스터
- 실제 현재 효과: ATK 계수 1.5로 단일 대상 피해; 5초 재사용; 5장 보유 시 계수 ×1.8; 5 거리 돌진
- 실제 현재 동작: layer_ruids 2개; 타입 animationclip/animationclip; 스타일 clip/clip; 지연 0/0.16초; 지속 0.55/0.65초; 시전자가 목표 방향으로 돌진
...
- 효과 발생 위치: 시전자 전방 15% 지점에서 ‘저돌 맹진’의 멧돼지 어금니를 닮은 두 갈래 전방 압축선과 흙먼지이 시작되어 발밑 높이와 공격축을 맞춤
- 진행 방향: 멧돼지 어금니를 닮은 두 갈래 전방 압축선과 흙먼지이 오른쪽으로 압축·가속하고 충돌점에서 짧게 넓어진 뒤 반대 방향 파편 없이 소멸
- 대상 표현: 확정 효과 ‘ATK 계수 1.5로 단일 대상 피해; 5초 재사용; 5장 보유 시 계수 ×1.8; 5 거리 돌진’의 전방 피격 대상과 최초 충돌점을 표시하고 타격광은 대상 중심을 가리지 않는 외곽 고리로 제한
