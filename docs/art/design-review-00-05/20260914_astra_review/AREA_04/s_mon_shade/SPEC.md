...
- monster_id: `m_shade`
- 몬스터 이름: 셰이드
- monster image RUID: `4f763744e0ac49469d2305e3c73254b7`
- skill_id: `s_mon_shade`
- 최종 스킬 이름: **심연의 장막**
- 스킬 타입: **액티브**
- 보스 여부: 보스
- 실제 현재 효과: INT 계수 2.1로 반경 4.8 범위 대상 제한 없음 피해; 7초 재사용; 5장 보유 시 계수 ×1.8
- 실제 현재 동작: layer_ruids 2개; 타입 animationclip/animationclip; 스타일 clip/clip; 지연 0/0.12초; 지속 0.65/0.8초

## 원작/지역 연결

[P][A] 셰이드의 어두운 이름과 ‘심연의 장막’은 분위기상 연결된다.

## 시각 번역

- 핵심 소재: 빛을 삼키는 반투명 장막과 가장자리의 보랏빛 잔광. ‘셰이드 / 심연의 장막’ 전용 소재이며 몬스터 본체는 VFX에 직접 넣지 않음
- 주 색상: 심연 흑보라 #272335; 핵심 실루엣의 중간톤과 어두운 외곽에 사용
- 보조 색상: 잔광 보라 #70538B; 타격 코어·잔상·소수 입자에만 사용해 같은 Area의 다른 몬스터와 구분
- 효과 발생 위치: 시전자 몸통 중심과 발밑 사이의 고정 피봇에서 ‘심연의 장막’의 빛을 삼키는 반투명 장막과 가장자리의 보랏빛 잔광이 먼저 나타남
- 진행 방향: 빛을 삼키는 반투명 장막과 가장자리의 보랏빛 잔광의 고유 결을 따라 한 번 확장·수축하며 불필요한 화면 횡단은 하지 않음
- 대상 표현: 확정 효과 ‘INT 계수 2.1로 반경 4.8 범위 대상 제한 없음 피해; 7초 재사용; 5장 보유 시 계수 ×1.8’가 지정한 대상만 표현하고 몬스터·플레이어 본체 실루엣은 넣지 않음
