...
- 효과 발생 위치: 시전자 전방 15% 지점에서 ‘리본 돌진’의 분홍 리본 매듭이 전방으로 길게 풀리는 돌진 궤적이 시작되어 발밑 높이와 공격축을 맞춤
- 진행 방향: 분홍 리본 매듭이 전방으로 길게 풀리는 돌진 궤적이 오른쪽으로 압축·가속하고 충돌점에서 짧게 넓어진 뒤 반대 방향 파편 없이 소멸
- 대상 표현: 확정 효과 ‘ATK 계수 1.8로 단일 대상 피해; 5초 재사용; 5장 보유 시 계수 ×1.8; 5.5 거리 돌진’의 전방 피격 대상과 최초 충돌점을 표시하고 타격광은 대상 중심을 가리지 않는 외곽 고리로 제한
