...
- monster_id: `m_dodo`
- 몬스터 이름: 도도
- monster image RUID: `2d63f90f9d464f7192713ad9209e9e63`
- skill_id: `s_mon_dodo`
- 최종 스킬 이름: **기억 포식**
- 스킬 타입: **액티브**
- 보스 여부: 보스
- 실제 현재 효과: INT 계수 5.45로 반경 7 범위 대상 제한 없음 피해; 11초 재사용; 5장 보유 시 계수 ×1.8
- 실제 현재 동작: layer_ruids 2개; 타입 animationclip/animationclip; 스타일 clip/clip; 지연 0/.22초; 지속 .8/.92초; 투사체 72e16f10f6ec4cf0a1fe3146e73f0856가 목표 방향으로 이동

## 원작/지역 연결

[P][A] 도도와 시간의 신전 추억의 길은 연결된다.

## 시각 번역

- 핵심 소재: 빛바랜 기억 조각을 안쪽으로 빨아들이는 검은 포식구. ‘도도 / 기억 포식’ 전용 소재이며 몬스터 본체는 VFX에 직접 넣지 않음
- 주 색상: 공허 남흑 #283141; 핵심 실루엣의 중간톤과 어두운 외곽에 사용
- 보조 색상: 기억 황백 #D5C9A3; 타격 코어·잔상·소수 입자에만 사용해 같은 Area의 다른 몬스터와 구분
- 효과 발생 위치: 시전자 또는 지정 충돌점의 지면 중심에서 ‘기억 포식’의 빛바랜 기억 조각을 안쪽으로 빨아들이는 검은 포식구이 먼저 식별되도록 발생
- 진행 방향: 빛바랜 기억 조각을 안쪽으로 빨아들이는 검은 포식구이 중심에서 방사 또는 수직으로 확장하고 절정 뒤 파편은 원점으로 되감기지 않음
- 대상 표현: 확정 효과 ‘INT 계수 5.45로 반경 7 범위 대상 제한 없음 피해; 11초 재사용; 5장 보유 시 계수 ×1.8’의 범위 안 대상만 표시하며 중심 타격광과 바깥 범위 경계를 분리해 다중 피격을 읽히게 함
