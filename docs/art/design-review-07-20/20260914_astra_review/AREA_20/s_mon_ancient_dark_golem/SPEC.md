...
- 효과 발생 위치: 시전자 또는 지정 충돌점의 지면 중심에서 ‘고대 암흑 지진’의 고대 암석 균열이 지면을 가로지르며 검은 돌기둥을 세우는 지진이 먼저 식별되도록 발생
- 진행 방향: 고대 암석 균열이 지면을 가로지르며 검은 돌기둥을 세우는 지진이 중심에서 방사 또는 수직으로 확장하고 절정 뒤 파편은 원점으로 되감기지 않음
- 대상 표현: 확정 효과 ‘ATK 계수 6.45로 반경 6.4 범위 최대 5대상 피해; 10초 재사용; 5장 보유 시 계수 ×1.8’의 범위 안 대상만 표시하며 중심 타격광과 바깥 범위 경계를 분리해 다중 피격을 읽히게 함
