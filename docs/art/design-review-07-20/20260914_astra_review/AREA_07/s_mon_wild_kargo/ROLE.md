# Runtime role map — 와일드카고 / 야수의 그림자 돌진

- monster_id: `m_wild_kargo`
- skill_id: `s_mon_wild_kargo`
- skill_type: `액티브`
- required NEW_ART roles: **ICON | VFX**
- declared current motion: layer_ruids 2개; 타입 animationclip/animationclip; 스타일 clip/clip; 지연 0/0.04초; 지속 0.52/0.65초; 시전자가 목표 방향으로 돌진
