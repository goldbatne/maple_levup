...
- 효과 발생 위치: 시전자 전방 발사 피봇에서 ‘별빛 탄환’의 작은 별핵이 꼬리별 잔상을 달고 직선으로 날아가는 탄이 완성되며 몬스터 본체 자리는 비워 둠
- 진행 방향: 작은 별핵이 꼬리별 잔상을 달고 직선으로 날아가는 탄이 오른쪽 한 방향으로 이동하고 꼬리·잔상은 발사점 쪽에만 남김
- 대상 표현: 확정 효과 ‘INT 계수 2.45로 단일 대상 피해; 5초 재사용; 5장 보유 시 계수 ×1.8’의 전방 피격 대상과 충돌점을 표시하며 발사체 실루엣과 충돌광을 서로 다른 프레임으로 분리
