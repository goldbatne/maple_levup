...
- monster_id: `m_eliza`
- 몬스터 이름: 엘리쟈
- monster image RUID: `d458879e2e2949f2bb2e915ff67fbc64`
- skill_id: `s_mon_eliza`
- 최종 스킬 이름: **여신의 정원 폭풍**
- 스킬 타입: **액티브**
- 보스 여부: 보스
- 실제 현재 효과: INT 계수 3로 반경 5.8 범위 대상 제한 없음 피해; 8초 재사용; 5장 보유 시 계수 ×1.8
- 실제 현재 동작: layer_ruids 2개; 타입 animationclip/animationclip; 스타일 clip/clip; 지연 0/0.22초; 지속 0.72/0.85초

## 원작/지역 연결

[W2] 엘리쟈는 여신의 사랑을 받던 애완동물이며 엘리쟈의 정원과 연결된다.

## 시각 번역

- 핵심 소재: 정원 잎과 꽃잎을 감아 올리는 여신풍 나선 폭풍. ‘엘리쟈 / 여신의 정원 폭풍’ 전용 소재이며 몬스터 본체는 VFX에 직접 넣지 않음
- 주 색상: 정원 녹색 #68B86B; 핵심 실루엣의 중간톤과 어두운 외곽에 사용
- 보조 색상: 신성 금빛 #F6D77B; 타격 코어·잔상·소수 입자에만 사용해 같은 Area의 다른 몬스터와 구분
- 효과 발생 위치: 시전자 또는 지정 충돌점의 지면 중심에서 ‘여신의 정원 폭풍’의 정원 잎과 꽃잎을 감아 올리는 여신풍 나선 폭풍이 먼저 식별되도록 발생
- 진행 방향: 정원 잎과 꽃잎을 감아 올리는 여신풍 나선 폭풍이 중심에서 방사 또는 수직으로 확장하고 절정 뒤 파편은 원점으로 되감기지 않음
- 대상 표현: 확정 효과 ‘INT 계수 3로 반경 5.8 범위 대상 제한 없음 피해; 8초 재사용; 5장 보유 시 계수 ×1.8’의 범위 안 대상만 표시하며 중심 타격광과 바깥 범위 경계를 분리해 다중 피격을 읽히게 함
