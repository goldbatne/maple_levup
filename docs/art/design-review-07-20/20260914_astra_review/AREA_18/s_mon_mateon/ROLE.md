# Runtime role map — 마티안 / 마티안 광선탄

- monster_id: `m_mateon`
- skill_id: `s_mon_mateon`
- skill_type: `액티브`
- required NEW_ART roles: **ICON | VFX | PROJECTILE_READING**
- declared current motion: layer_ruids 2개; 타입 animationclip/animationclip; 스타일 clip/clip; 지연 0/.2초; 지속 .65/.78초; 투사체 22db356cc60940089b7f5d592c7d5813가 목표 방향으로 이동
