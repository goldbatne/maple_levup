...
- monster_id: `m_homun`
- 몬스터 이름: 호문
- monster image RUID: `8f0fb531779d41738664009091d7b017`
- skill_id: `s_mon_homun`
- 최종 스킬 이름: **플라스크 독무**
- 스킬 타입: **액티브**
- 보스 여부: 일반 몬스터
- 실제 현재 효과: INT 계수 4.1로 반경 5.4 범위 최대 4대상 피해; 8초 재사용; 5장 보유 시 계수 ×1.8
- 실제 현재 동작: layer_ruids 1개; 타입 animationclip; 스타일 clip; 지연 0초; 지속 0.82초

## 원작/지역 연결

[P][A] 호문과 마가티아 연금술 지역은 연결되나 ‘플라스크 독무’는 확인되지 않았다.

## 시각 번역

- 핵심 소재: 금 간 플라스크에서 새는 자주빛 독무와 액체 방울. ‘호문 / 플라스크 독무’ 전용 소재이며 몬스터 본체는 VFX에 직접 넣지 않음
- 주 색상: 독무 자주 #7E4C8F; 핵심 실루엣의 중간톤과 어두운 외곽에 사용
- 보조 색상: 약액 녹색 #83B85B; 타격 코어·잔상·소수 입자에만 사용해 같은 Area의 다른 몬스터와 구분
- 효과 발생 위치: 시전자 또는 지정 충돌점의 지면 중심에서 ‘플라스크 독무’의 금 간 플라스크에서 새는 자주빛 독무와 액체 방울이 먼저 식별되도록 발생
- 진행 방향: 금 간 플라스크에서 새는 자주빛 독무와 액체 방울이 중심에서 방사 또는 수직으로 확장하고 절정 뒤 파편은 원점으로 되감기지 않음
- 대상 표현: 확정 효과 ‘INT 계수 4.1로 반경 5.4 범위 최대 4대상 피해; 8초 재사용; 5장 보유 시 계수 ×1.8’의 범위 안 대상만 표시하며 중심 타격광과 바깥 범위 경계를 분리해 다중 피격을 읽히게 함
