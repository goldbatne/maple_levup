# Runtime role map — 로이드 / 알카드노 에너지탄

- monster_id: `m_roid`
- skill_id: `s_mon_roid`
- skill_type: `액티브`
- required NEW_ART roles: **ICON | VFX | PROJECTILE_READING**
- declared current motion: layer_ruids 1개; 타입 animationclip; 스타일 clip; 지연 0.2초; 지속 0.72초; 투사체 e51545cbf94349f59f4431e2e76d2cdc가 목표 방향으로 이동
