...
- monster_id: `m_pianus`
- 몬스터 이름: 피아누스
- monster image RUID: `207c5d6dcee243ad9a141397244ba9a9`
- skill_id: `s_mon_pianus`
- 최종 스킬 이름: **심해왕의 광선**
- 스킬 타입: **액티브**
- 보스 여부: 보스
- 실제 현재 효과: INT 계수 3.45로 반경 6.8 범위 대상 제한 없음 피해; 10초 재사용; 5장 보유 시 계수 ×1.8
- 실제 현재 동작: layer_ruids 2개; 타입 animationclip/animationclip; 스타일 clip/clip; 지연 0/0.25초; 지속 0.82/0.95초

## 원작/지역 연결

[P][A] 현행 모델/방 배치에서 피아누스의 모델 ID·RUID와 아쿠아로드 배치를 확인했다. 스킬명은 몬스터 고유명·종족명 또는 지역 핵심어를 직접 사용한다. 원작의 공식 스킬명으로 확인된 것은 아니다.

## 시각 번역

- 핵심 소재: 심해 왕관형 발광기관에서 뻗는 굵은 수평 광선. ‘피아누스 / 심해왕의 광선’ 전용 소재이며 몬스터 본체는 VFX에 직접 넣지 않음
- 주 색상: 심해 청자 #235D79; 핵심 실루엣의 중간톤과 어두운 외곽에 사용
- 보조 색상: 광선 백청 #BDF7FF; 타격 코어·잔상·소수 입자에만 사용해 같은 Area의 다른 몬스터와 구분
- 효과 발생 위치: 시전자 전방 발사 피봇에서 ‘심해왕의 광선’의 심해 왕관형 발광기관에서 뻗는 굵은 수평 광선이 완성되며 몬스터 본체 자리는 비워 둠
- 진행 방향: 심해 왕관형 발광기관에서 뻗는 굵은 수평 광선이 오른쪽 한 방향으로 이동하고 꼬리·잔상은 발사점 쪽에만 남김
- 대상 표현: 확정 효과 ‘INT 계수 3.45로 반경 6.8 범위 대상 제한 없음 피해; 10초 재사용; 5장 보유 시 계수 ×1.8’의 전방 피격 대상과 충돌점을 표시하며 발사체 실루엣과 충돌광을 서로 다른 프레임으로 분리
