...
- monster_id: `m_shark`
- 몬스터 이름: 샤크
- monster image RUID: `b95f05df46124b3485d0a15bb79b10fb`
- skill_id: `s_mon_shark`
- 최종 스킬 이름: **포식자의 수류탄**
- 스킬 타입: **액티브**
- 보스 여부: 일반 몬스터
- 실제 현재 효과: ATK 계수 3.15로 단일 대상 피해; 7초 재사용; 5장 보유 시 계수 ×1.8
- 실제 현재 동작: layer_ruids 1개; 타입 animationclip; 스타일 clip; 지연 0.22초; 지속 0.72초; 투사체 209c4567073b424e8d445cea7efb80e3가 목표 방향으로 이동

## 원작/지역 연결

[P][A] 샤크의 포식자 이미지는 연결되나 ‘수류탄’은 水流 탄환과 手榴彈이 중의적이다.

## 시각 번역

- 핵심 소재: 이빨 톱니가 둘린 압축 수류탄과 기포 꼬리. ‘샤크 / 포식자의 수류탄’ 전용 소재이며 몬스터 본체는 VFX에 직접 넣지 않음
- 주 색상: 상어 청회 #4E7890; 핵심 실루엣의 중간톤과 어두운 외곽에 사용
- 보조 색상: 폭발 청백 #AEEAF4; 타격 코어·잔상·소수 입자에만 사용해 같은 Area의 다른 몬스터와 구분
- 효과 발생 위치: 시전자 전방 발사 피봇에서 ‘포식자의 수류탄’의 이빨 톱니가 둘린 압축 수류탄과 기포 꼬리이 완성되며 몬스터 본체 자리는 비워 둠
- 진행 방향: 이빨 톱니가 둘린 압축 수류탄과 기포 꼬리이 오른쪽 한 방향으로 이동하고 꼬리·잔상은 발사점 쪽에만 남김
- 대상 표현: 확정 효과 ‘ATK 계수 3.15로 단일 대상 피해; 7초 재사용; 5장 보유 시 계수 ×1.8’의 전방 피격 대상과 충돌점을 표시하며 발사체 실루엣과 충돌광을 서로 다른 프레임으로 분리
...
- ‘수류탄’은 압축된 물의 흐름(水流) 탄환 의미로 해석하고 현대식 손폭탄을 그리지 않는다.
