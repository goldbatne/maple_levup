# Runtime role map — 원공 / 천도 투척

- monster_id: `m_peach_monkey`
- skill_id: `s_mon_peach_monkey`
- skill_type: `액티브`
- required NEW_ART roles: **ICON | VFX | PROJECTILE_READING**
- declared current motion: layer_ruids 1개; 타입 animationclip; 스타일 clip; 지연 0초; 지속 0.65초; 투사체 9ca14ee512b1489cbb54b2b9833388cd가 목표 방향으로 이동
