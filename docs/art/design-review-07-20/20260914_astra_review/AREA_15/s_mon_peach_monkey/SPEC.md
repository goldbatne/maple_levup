...
- 몬스터 이름: 원공
- monster image RUID: `15e255981ed54cf092a136b1526aa055`
- skill_id: `s_mon_peach_monkey`
- 최종 스킬 이름: **천도 투척**
- 스킬 타입: **액티브**
- 보스 여부: 일반 몬스터
- 실제 현재 효과: DEX 계수 4.6로 단일 대상 피해; 7초 재사용; 5장 보유 시 계수 ×1.8
- 실제 현재 동작: layer_ruids 1개; 타입 animationclip; 스타일 clip; 지연 0초; 지속 0.65초; 투사체 9ca14ee512b1489cbb54b2b9833388cd가 목표 방향으로 이동

## 원작/지역 연결

[P][A] 현행 모델/방 배치에서 원공의 모델 ID·RUID와 무릉도원 배치를 확인했다. 스킬명은 몬스터 고유명·종족명 또는 지역 핵심어를 직접 사용한다. 원작의 공식 스킬명으로 확인된 것은 아니다.

## 시각 번역

- 핵심 소재: 천도 복숭아가 잎사귀 꼬리를 달고 포물선으로 날아가는 탄. ‘원공 / 천도 투척’ 전용 소재이며 몬스터 본체는 VFX에 직접 넣지 않음
- 주 색상: 천도 분홍 #F09691; 핵심 실루엣의 중간톤과 어두운 외곽에 사용
- 보조 색상: 복숭아잎 녹색 #6FA45A; 타격 코어·잔상·소수 입자에만 사용해 같은 Area의 다른 몬스터와 구분
- 효과 발생 위치: 시전자 전방 발사 피봇에서 ‘천도 투척’의 천도 복숭아가 잎사귀 꼬리를 달고 포물선으로 날아가는 탄이 완성되며 몬스터 본체 자리는 비워 둠
- 진행 방향: 천도 복숭아가 잎사귀 꼬리를 달고 포물선으로 날아가는 탄이 오른쪽 한 방향으로 이동하고 꼬리·잔상은 발사점 쪽에만 남김
- 대상 표현: 확정 효과 ‘DEX 계수 4.6로 단일 대상 피해; 7초 재사용; 5장 보유 시 계수 ×1.8’의 전방 피격 대상과 충돌점을 표시하며 발사체 실루엣과 충돌광을 서로 다른 프레임으로 분리
