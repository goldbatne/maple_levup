...
- 몬스터 이름: 블루 와이번
- monster image RUID: `07bc82953fca4677bc00f74680ec337b`
- skill_id: `s_mon_blue_wyvern`
- 최종 스킬 이름: **빙룡 숨결**
- 스킬 타입: **액티브**
- 보스 여부: 일반 몬스터
- 실제 현재 효과: INT 계수 4.9로 단일 대상 피해; 8초 재사용; 5장 보유 시 계수 ×1.8
- 실제 현재 동작: layer_ruids 2개; 타입 animationclip/animationclip; 스타일 clip/clip; 지연 0/0.2초; 지속 0.72/0.82초

## 원작/지역 연결

[P][A] 현행 모델/방 배치에서 블루 와이번의 모델 ID·RUID와 미나르숲 배치를 확인했다. 스킬명은 몬스터 고유명·종족명 또는 지역 핵심어를 직접 사용한다. 원작의 공식 스킬명으로 확인된 것은 아니다.
...
- 효과 발생 위치: 시전자 전방 발사 피봇에서 ‘빙룡 숨결’의 용의 입김처럼 길게 뻗는 빙결 숨결과 쐐기 얼음이 완성되며 몬스터 본체 자리는 비워 둠
- 진행 방향: 용의 입김처럼 길게 뻗는 빙결 숨결과 쐐기 얼음이 오른쪽 한 방향으로 이동하고 꼬리·잔상은 발사점 쪽에만 남김
- 대상 표현: 확정 효과 ‘INT 계수 4.9로 단일 대상 피해; 8초 재사용; 5장 보유 시 계수 ×1.8’의 전방 피격 대상과 충돌점을 표시하며 발사체 실루엣과 충돌광을 서로 다른 프레임으로 분리
