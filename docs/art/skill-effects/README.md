# 몬스터 스킬 시전 이펙트 원본 (T21-1 · T32-3)

몬스터 스킬 **11종**의 **시전 이펙트**를 직접 그렸다. 아이콘(`../skill-icons/`)과
...
| style | 스킬 | 움직임 |
|---|---|---|
| `burst` | 몸통 박치기 · 도끼 휘두르기 · 뼈 무덤 · 대지 가르기 | 확 커지며 조금 돈다 |
| `ring` | 푸른 껍질 · 강철 가죽 | 천천히 커진다 (안 돈다 — 돌면 고리가 어지럽다) |
| `cloud` | 포자 살포 · 어둠의 뿌리 · 화염 돌풍 | 부풀며 위로 떠오른다 |
| `pierce` | 뿔 들이받기 · 저돌 맹진 | 앞으로 나가며 길어진다 |

**T32-3에서 스타일을 새로 만들지 않았다.** 넷이 움직임을 충분히 덮고,
