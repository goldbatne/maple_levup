...
local function AbandonRogueliteParticipant(self,userId)
        ...
        if #self.RogueParticipantIds == 0 then
            ...
            self.RogueRunRevision = self.RogueRunRevision + 1
