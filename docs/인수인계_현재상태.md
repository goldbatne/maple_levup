...
- 갱신: 2026-08-28 (T36-1 area_03 엘리니아 데이터 계층)
...
>
> **1. area_03 엘리니아 — T36-1에서 데이터 계층까지 됐다.**
> 남은 것은 **맵 3개(map21~map23) + 몬스터 모델 3개**, 그리고 그때 `LandmarkTable`에
> `20,area,area_03`을 넣어 실제로 여는 것이다. **지금은 일부러 닫혀 있다** — 맵이 없다.
>
