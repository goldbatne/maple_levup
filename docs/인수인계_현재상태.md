...
- 갱신: 2026-08-28 (T36-3 area_03 엘리니아 5방 완성)
...
>
> **1. area_03 엘리니아 — T36-3에서 5방으로 닫혔다.**
> 남은 것은 **포획 스킬 5종**(아이콘·이펙트 포함 — T32와 같은 분량)이다.
> `MonsterTable`의 `drop_skill_id` 5칸이 비어 있어 **지금은 포획이 안 되는 지역**이다.
