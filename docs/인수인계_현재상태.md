...
- 갱신: 2026-08-31 (T56 히어로 보상 패시브 전환)
...
> **현재 이어갈 지점(T56 이후):** Maker Refresh → Play로 히어로의 검 드랍·가방 `xN/5`·STR 1% 자동 적용·히어로의 보스 스킬 사용을 먼저 확인 → T54 최종 화면 1회 재확인 → 새 `Mushmom.model` 등록 확인 → `r_05`에서
...
- 기준: `feat/t50-nautilus` (원격 최신 커밋 `d704f54`, PR #171) 위의 **T56 로컬 변경**
- T56은 아직 커밋·푸시하지 않았다. `.agents/`·`.codex/`는 로컬 도구 파일이므로 커밋하지 않는다
