...
- 갱신: 2026-08-24 (T23-1 바위 던지기 쿨다운)
...
| **아이템 퀵슬롯** (T13-5b) | 동작. 오른쪽 아래 2칸, 키 `1`·`2`로 마신다. 올라가는 것은 자동 배정. **키 재설정은 안 만든다** — 2026-08-24 대표 지시로 취소(`1`·`2` 고정) | `ui/ItemQuickSlot.ui`, `UI/ItemQuickSlotBar.mlua` |
