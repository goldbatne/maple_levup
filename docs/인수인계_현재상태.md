...
- 갱신: 2026-08-28 (T34 EXP 곡선 + 지역 20칸 확정)
...
>
> **0. ⚠ 지역 선택 창부터 고칠 것.** `ui/AreaSelect.ui`가 **칸 4개**(`Slot0`~`Slot3`)뿐이고
> 스크롤이 없다 — **5번째 지역부터 조용히 안 뜬다.** 지역을 늘리기 전에 반드시 먼저 한다.
> 그다음 지역당 방 수를 정하고 area_03(엘리니아 Lv11~20)부터 만든다.
